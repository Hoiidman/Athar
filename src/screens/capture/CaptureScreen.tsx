...
const styles = StyleSheet.create({
  container: { flex: 1 },
  permissionScreen: { flex: 1 },
  permissionMessage: {},
  grantButton: {},
  grantText: {},
  voiceBackground: { flex: 1 },
  voiceMicButton: {},
  voiceHint: {},
  ...
  albumButton: { flexDirection: 'row', alignItems: 'center' },
  albumLabel: {},
  captureRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%' },
  iconButton: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center' },
  thumbnailButton: { width: THUMBNAIL_SIZE, height: THUMBNAIL_SIZE },
